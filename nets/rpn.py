...
from utils.anchors import generate_anchor_base, _enmuerate_shifted_anchor
...
class RegionProposalNetwork(nn.Module):
    ...
    def forward(self, x, img_size, scale=1.):
        ...
        # 回归预测
        rpn_locs = self.loc(h)
        rpn_locs = rpn_locs.permute(0,2,3,1).contuguous().view(n, -1, 4)
        # 分类预测
        ...
        # 生成先验框
        anchor = _enmuerate_shifted_anchor(
